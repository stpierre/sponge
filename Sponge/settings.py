# Django settings for sponge project.
import os
import sys
import djcelery
...
SECRET_KEY = '8rwa^x(8)(s%s4rp7o6*lhkelv97(o$f+r5da&guj9d^2*0*e5'
...
MIDDLEWARE_CLASSES = (
    ...
    'sponge.middleware.CeleryTaskTrackerMiddleware',
    'sponge.middleware.PulpServerMiddleware',
)

ROOT_URLCONF = 'Sponge.urls'
